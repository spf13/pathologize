...
func Test_CleanFilename(t *testing.T) {
	tests := []struct {
		...
		{"reserved with trailing space and extension", "CON .txt", "CON_ .txt"},
		{"reserved with trailing dot, space and extension", "CON. .txt", "CON_. .txt"},
		{"reserved lowercase with trailing space and extension", "con .txt", "CON_ .txt"},
		{"reserved with space", "CON ", "CON_"},
