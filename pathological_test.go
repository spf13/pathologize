...
func Test_CleanFilename(t *testing.T) {
	tests := []struct {
		...
		{"reserved with space and extension", "CON .txt", "CON_.txt"},
		{"reserved with spaces and multiple extensions", "CON  .tar.gz", "CON_.tar.gz"},
		{"reserved with dot space and extension", "CON. .txt", "CON_. .txt"},
