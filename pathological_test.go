...
func Test_CleanFilename(t *testing.T) {
	tests := []struct {
		...
		{"long", "", "foobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoobarbazfoo"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
