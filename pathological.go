...
// isInvalidCharacter returns true if the rune is not allowed in filenames.
...
// Optimization: zero-allocation fast path for clean strings via IndexFunc/Map instead of regexp.
