...
func removeTrailing(filename string) string {
	// Trim trailing dots and whitespace characters
	// This uses strings.TrimRight which is much faster and avoids regex allocations.
	// We explicitly define whitespace (excluding \v) to perfectly match the behavior of \s in regexp.
